...
classifiers = [
    ...
    GradientBoostingClassifier(random_state=100, n_estimators=150,min_samples_split=100, max_depth=6),
    LinearSVC(),
    SGDClassifier()
    ]

for classifier in classifiers:
    pipe = Pipeline(steps=[('vect', CountVectorizer(tokenizer=text_preprocess, min_df=5, ngram_range=(1, 2))),
